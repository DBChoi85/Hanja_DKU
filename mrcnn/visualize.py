...
def display_instances(mysize,img_file_name, image, boxes, masks, class_ids, class_names,
    ...
    for i in range(N):
        ...
        if show_bbox:
            ...
            #io.imsave("C:\\Users\\ialab\\Desktop\\img_json\\mm_a_003_523a\\pre_%s_%d.jpg" % (img_file_name, i), img)
    ...
    if auto_show:
        ...
        plt.savefig('C:\\Users\\ialab\\Desktop\\img_json\\result_01\\test_%d_%s' % (count_mask, img_file_name))
